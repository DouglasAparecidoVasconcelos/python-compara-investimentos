...
while opcao != 0:
    ...
    if opcao == 1:
        ...
        if poupanca.montante > cdi.montante and lci.montante:
            print("O investimento na POUPANÇA é o mais rentável !!!")
        elif cdi.montante > poupanca.montante and lci.montante:
            print("O investimento na CDI é o mais rentável !!!")
        elif lci.montante > poupanca.montante and cdi.montante:
            print("O investimento na LCI é o mais rentável !!!")
